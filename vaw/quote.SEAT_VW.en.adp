...
<%
    ...
    if {$cost_type_id == [im_cost_type_quote]} { set doc_title "Quote" }
...
<br>
  ...
  <table border="0" cellspacing="1" cellpadding="1">
    ...
    <tr>
      <td class=rowtitle>Supplier no:&nbsp;</td>
...
<!--      <td class=rowtitle><nobr><%=$forma_pago_string %></nobr></td>-->
      ...
      <td class=address colspan=3>Prices do not include VAT.<!-- <%= $invoice_payment_method_desc %> --></td> 
    </tr>
    <tr><td><br/></td>
        <td><br/></td>
	<td>&nbsp;</td>
