...
<%
    ...
    if {$cost_type_id == [im_cost_type_invoice]} { set doc_title "Factura" }
    if {$cost_type_id == [im_cost_type_delivery_note]} { set doc_title "Albar&aacute;n" }
...
%>
      ...
      <p><b><%= $doc_title %><b></p>
        ...
        <table border="0" cellspacing="1" cellpadding="1">
          ...
          <tr> 
            <td class=address>08820 El Prat de Llobregat</td>
          </tr>
            <tr>
            <td class=address>Barcelona</td>
          </tr>
