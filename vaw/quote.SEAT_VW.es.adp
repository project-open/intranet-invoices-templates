...
-->
          <tr> 
            <td class="address">Tel&eacute;fono&nbsp;</td>
...
<%
    ...
    if {$cost_type_id == [im_cost_type_invoice]} { set doc_title "Abono Factura" }
...
<br>
  ...
  <table border="0" cellspacing="1" cellpadding="1">
    <tr> 
      <td class=rowtitle>Fecha:&nbsp;</td>
      <td class=address><%=$invoice_date_pretty %></td>
    </tr>
    <tr>
      <td class=rowtitle>Proveedor no:&nbsp;</td>
      <td class=address>29916</td>
    </tr>

    <tr> 
      <td class=rowtitle>Documento no:&nbsp;</td>
...
set nota_string "Nota:"
	...
	set cond_pago_string "Condiciones de pago:&nbsp;"
	...
	if {"" != [string trim $invoice_payment_method_desc]} { 
	    set forma_pago_string "Forma de pageo:" 
        }
    }
...
<tr>
          <td class=roweven colspan="6" align=right><B>Total </B></td>
...
-->
    <tr> 
      ...
      <td class=address><%= $cond_pago_string %></td>
    </tr>
    <tr> 
<!--      <td class=rowtitle><nobr><%=$forma_pago_string %></nobr></td>-->
      
      <td class=address colspan=3>Los precios indicados no incluyen el IVA.<!-- <%= $invoice_payment_method_desc %> --></td> 
    </tr>
    <tr><td><br/></td>
        <td><br/></td>
	<td>&nbsp;</td>
